...
namespace ProyectoTalleresMecanicos.Molde
{
    internal class FormularioV
    {
        ...
        private DateTime formulariov_año;
        ...
        public DateTime Formulariov_año { get => formulariov_año; set => formulariov_año = value; }

        public FormularioV()
        {
        }

        public FormularioV(int formulariov_id, string formulariov_marca, string formulariov_modelo, DateTime formulariov_año, string formulariov_rutcliente, uint formulariov_telefonocliente, string formulariov_dueñovehiculo, string formulariov_correodueño)
        {
