...
namespace ProyectoTalleresMecanicos.Molde
{
    internal class Catalogoservicio
    {
        ...
        public DateTime Catalogoservicio_fecha_cita { get => catalogoservicio_fecha_cita; set => catalogoservicio_fecha_cita=value; }
        ...
        public DateTime Catalogoservicio_año_modelo { get => catalogoservicio_año_modelo; set => catalogoservicio_año_modelo=value; }
        ...
        public Catalogoservicio(int catalogoservicio_id, DateTime catalogoservicio_fecha_cita, string catalogoservicio_nombre_dueño, string catalogoservicio_modelo_vehiculo, DateTime catalogoservicio_año_modelo, string catalogoservicio_motivo_servicio)
        {
