...
INSERT INTO `inventario` VALUES (1,'Cubierta de volante',NULL,'Nuevo',2,5000),(2,'Juegos de llaves',NULL,'Nuevo',6,18000),(3,'Gatos hidráulicos',NULL,'Nuevo',5,34000),(4,'Compresor de aire',NULL,'Nuevo',11,46000),(5,'Multímetro automotriz',NULL,'Nuevo',4,40000);
...
INSERT INTO `usuario_cliente` VALUES (29,'Pedro Pedrales','Elpepe','19493693-1','923517596','Mikasa 117','ejemplo@gmail.com','12345',NULL),(30,'Geepeto Marmol','pin8','19463259-1','123456799','La otra casa 123','ejemplo2@gmail.com','54321',NULL),(31,'','','','','','','',NULL);
...
CREATE TABLE `usuario_mecanico` (
  ...
  `nombre_taller` varchar(100) DEFAULT NULL,
  `direccion_taller` varchar(100) DEFAULT NULL,
  `venta_producto` varchar(100) DEFAULT NULL,
  `telefono_taller` varchar(100) DEFAULT NULL,
...
INSERT INTO `usuario_mecanico` VALUES (4,'ubunto','Ububue','osas@gmail.com','qwerty','El Raspon','Al lado de mikasa 5584','si','19195168');
...
-- Dump completed on 2022-07-29 13:29:07
